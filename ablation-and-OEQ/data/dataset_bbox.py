...
class OxfordIIITPet(Dataset):
    def __init__(self, transform=None):
        ...
        self.bbox_dict = parse_bbox_txt("data/annotations/bbox_labels.txt")
    ...
    def __getitem__(self, item):
        ...
        bbox = self.bbox_dict.get(self.ids[item])
        return image, label, self.ids[item], bbox
